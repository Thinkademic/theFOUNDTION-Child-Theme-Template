$(function() {
     ...
     **********************************************************/
    $(".page-template-page_portfoliomaker-php").portfoliomaker('auto', 6, 3);
    $(".page-template-page_portfoliomakermodal-php").portfoliomaker('auto', 6, 3);
    ...
    /*****************************
     PORTFOLIO FILTER TAG
     *****************************/
    $(".page-template-page_portfoliomakermodal-php #portfolio_previewer a").fancybox({
        'autoScale'            : false,
     ...
     **********************************************************/
    $(".page-template-page_portfoliomaker-php").portfoliotoggle();
    $(".page-template-page_portfoliomakermodal-php").portfoliotoggle();
...
jQuery.fn.jcycleportfolio = function (targetclass) {
    ...
    $('.media_grouping').hoverIntent(
            function() {
                $('.media_controls').fadeIn();
            },
            function() {
                $('.media_controls').fadeOut();
            }
    );
